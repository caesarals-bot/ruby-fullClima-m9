...
class MaintenancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create maintenance" do
    assert_difference("Maintenance.count") do
      post maintenances_url, params: { maintenance: { ciudad: @maintenance.ciudad, materiales: @maintenance.materiales, tipo: @maintenance.tipo } }
    end
  ...
  test "should update maintenance" do
    patch maintenance_url(@maintenance), params: { maintenance: { ciudad: @maintenance.ciudad, materiales: @maintenance.materiales, tipo: @maintenance.tipo } }
