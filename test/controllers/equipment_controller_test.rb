...
class EquipmentControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equipment" do
    assert_difference("Equipment.count") do
      post equipment_index_url, params: { equipment: { descripcion: @equipment.descripcion, foto: @equipment.foto, nombre: @equipment.nombre, tipo: @equipment.tipo } }
    end
  ...
  test "should update equipment" do
    patch equipment_url(@equipment), params: { equipment: { descripcion: @equipment.descripcion, foto: @equipment.foto, nombre: @equipment.nombre, tipo: @equipment.tipo } }
